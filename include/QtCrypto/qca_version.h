...
/**
   ...
   Header file with 2.3.1 version
...
/**
   The major part of current 2.3.1 version.
*/

#define QCA_MAJOR_VERSION 2

/**
   The minor part of current 2.3.1 version.
*/

#define QCA_MINOR_VERSION 3

/**
   The patch part of current 2.3.1 version.
*/

#define QCA_PATCH_VERSION 1

/**
   The current version of 2.3.1 as string.
 */

#define QCA_VERSION_STR "2.3.1"

/**
   Can be used like #if (QCA_VERSION >= 2.3.1_VERSION_CHECK(2, 3, 1))
...
/**
   The current version of 2.3.1

   This provides you a compile time check of the 2.3.1 version.
